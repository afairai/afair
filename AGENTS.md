...
4. Path-scoped detail as needed (`docs/self-hosting.md`, `docs/clients/`, `analysis/`).
...
- Substrate is append-only per Invariant I2. No mutation, no deletion paths outside the documented right-to-erasure flow.
